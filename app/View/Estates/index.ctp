<div class="estates index">
	...
	<tr>
		<td><?php echo h($estate['Estate']['id']); ?>&nbsp;</td>
		<td><?php echo h($estate['Estate']['numeroficha']); ?>&nbsp;</td>
		...
		<td><?php echo h($estate['Estate']['created']); ?>&nbsp;</td>
		<td><?php echo h($estate['Estate']['modified']); ?>&nbsp;</td>
		<td>
